...
// {
    ...
    function readData() {
      ...
      addOnClick["Age"] = document.querySelector("#Age").value;
      addOnClick["City"] = document.querySelector("#city").value;
      console.log(document.querySelector("#female").checked)
      
      if (document.querySelector("#male").checked == true){
          addOnClick['Gender'] = 'male'
      }
      else{
          addOnClick['Gender'] = 'female'
      }
      return addOnClick
    }
    ...
    function Update(y) {
      ...
      console.log(selectedtr.cells[1].innerHTML)
      
      if (selectedtr.cells[1].innerHTML == "female"){
